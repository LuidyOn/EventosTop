...
import java.util.Objects; // Importe Objects para o método equals e hashCode
...
public class Palestrante {
    ...
    // IMPORTANTE: Adicione os métodos equals e hashCode para que as listas funcionem corretamente na comparação
    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        Palestrante that = (Palestrante) o;
        return id == that.id; // Palestrantes são iguais se tiverem o mesmo ID
    }
