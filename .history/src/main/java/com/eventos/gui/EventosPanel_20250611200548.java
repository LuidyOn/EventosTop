// src/main/java/com/eventos/gui/EventosPanel.java
...
public class EventosPanel extends JPanel {
    ...
    public EventosPanel() {
        ...
        add(scrollPane, BorderLayout.CENTER); // Adiciona a tabela ao centro do painel
        ...
        carregarEventos(); // Carrega os eventos ao iniciar o painel
    }
    ...
    private void carregarEventos() {
        ...
        for (Evento evento : eventos) {
            Object[] rowData = {
                    evento.getId(),
                    evento.getNome(),
                    evento.getData(), // LocalDate será exibido como string automaticamente
                    evento.getLocal(),
    ...
    private void adicionarEvento() {
        ...
        if (formDialog.isSalvo()) {
            // Se o evento foi salvo, recarrega a lista para mostrar o novo evento
            carregarEventos();
        }
    }
    ...
    private void editarEvento() {
        ...
        int eventoId = (int) tableModel.getValueAt(selectedRow, 0); // Pega o ID da primeira coluna
    ...
    private void visualizarEvento() {
        ...
        eventoOpt.ifPresent(evento -> {
            String detalhes = "ID: " + evento.getId() + "\n" +
                              ...
                              "Palestrantes: " + (evento.getPalestrantes().isEmpty() ? "Nenhum" : evento.getPalestrantes());
