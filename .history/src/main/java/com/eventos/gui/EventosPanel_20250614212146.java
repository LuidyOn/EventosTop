...
public class EventosPanel extends JPanel {
    ...
    private void carregarEventos() {
        ...
        for (Evento evento : eventos) {
            Object[] rowData = {
                    evento.getId(),
                    evento.getNome(),
                    evento.getData().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")), // Formata a data aqui
                    evento.getLocal(),
    ...
    private void visualizarEvento() {
        ...
        eventoOpt.ifPresent(evento -> {
            // Formatar palestrantes para exibição
            ...
            // NOVO: Formatar participantes para exibição
            ...
            String detalhes = "ID: " + evento.getId() + "\n" +
                              ...
                              "Participantes Inscritos: " + participantesStr; // NOVO
